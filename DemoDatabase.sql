...
insert Account(email,name,password,role) values ('GD123@gmail.com',N'Giang Vinh Diễn','GD1234',2)
insert Account(email,name,password,role) values ('DH123@gmail.com',N'Nguyễn Đặng Hiếu','DH1234',1)
